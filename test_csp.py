...
class MachineWork:
    ...
    def _device_config_func(self,slave_pos):
        ...
        device.sdo_write(0x60C5,0x0,bytes(ctypes.c_uint32(50000)))
        device.sdo_write(0x60C6,0x0,bytes(ctypes.c_uint32(50000)))
        device.sdo_write(0x6083,0x0,bytes(ctypes.c_uint32(4000)))
        device.sdo_write(0x6084,0x0,bytes(ctypes.c_uint32(4000)))
        device.sdo_write(0x607F,0x0,bytes(ctypes.c_uint32(5000)))
